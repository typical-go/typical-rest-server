...
// Source: github.com/typical-go/typical-rest-server/internal/generated/entity/app/data_access/postgresdb_repo (interfaces: BookRepo)

// Package postgresdb_repo_mock is a generated GoMock package.
package postgresdb_repo_mock
...
func (m *MockBookRepo) Create(arg0 context.Context, arg1 *postgresdb.Book) (int64, error) {
	m.ctrl.T.Helper()
...
func (m *MockBookRepo) Find(arg0 context.Context, arg1 ...sqkit.SelectOption) ([]*postgresdb.Book, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0}
	for _, a := range arg1 {
		varargs = append(varargs, a)
...
func (m *MockBookRepo) Patch(arg0 context.Context, arg1 *postgresdb.Book, arg2 sqkit.UpdateOption) (int64, error) {
	m.ctrl.T.Helper()
...
func (m *MockBookRepo) Update(arg0 context.Context, arg1 *postgresdb.Book, arg2 sqkit.UpdateOption) (int64, error) {
	m.ctrl.T.Helper()
