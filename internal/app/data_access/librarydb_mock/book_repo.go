...
// Source: github.com/typical-go/typical-rest-server/internal/app/data_access/librarydb (interfaces: BookRepo)

// Package librarydb_mock is a generated GoMock package.
package librarydb_mock
...
func (m *MockBookRepo) Create(arg0 context.Context, arg1 *librarydb.Book) (int64, error) {
	m.ctrl.T.Helper()
...
func (m *MockBookRepo) Find(arg0 context.Context, arg1 ...dbkit.SelectOption) ([]*librarydb.Book, error) {
	m.ctrl.T.Helper()
...
func (m *MockBookRepo) Patch(arg0 context.Context, arg1 *librarydb.Book, arg2 dbkit.UpdateOption) (int64, error) {
	m.ctrl.T.Helper()
...
func (m *MockBookRepo) Update(arg0 context.Context, arg1 *librarydb.Book, arg2 dbkit.UpdateOption) (int64, error) {
	m.ctrl.T.Helper()
