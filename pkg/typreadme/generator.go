...
// Generate readme
func (Generator) Generate(ctx *typcore.Context, w io.Writer) (err error) {
	...
	if typcore.IsActionable(ctx.AppModule) {
...
func fields(ctx *typcore.Context) (keys coll.Strings, m map[string]typcore.Field) {
