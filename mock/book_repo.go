...
// Source: app/entity/book_repo.go
...
import (
	...
	entity "github.com/typical-go/typical-rest-server/app/entity"
	reflect "reflect"
)
...
func (m *MockBookRepository) Find(id int64) (*entity.Book, error) {
	m.ctrl.T.Helper()
...
func (m *MockBookRepository) Insert(book entity.Book) (int64, error) {
	m.ctrl.T.Helper()
...
func (m *MockBookRepository) Update(book entity.Book) error {
	m.ctrl.T.Helper()
